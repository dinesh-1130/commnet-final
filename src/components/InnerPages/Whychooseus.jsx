...
//             We Deliver{" "}
//             <span className="inline-block">Technology with Purpose</span>
//           </h1>
//           <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
//             Discover how Commnet empowers modern businesses with efficiency,
//             reliability, and innovation across regions.
//           </p>
//         </div>
//       </section>
...
//               Hear directly from our Managing Director about our vision, values,
...
//                 At Commnet, we believe in delivering solutions that not only
//                 meet current needs but anticipate future challenges in the
//                 digital landscape.
//               </p>
...
//                     200% Year-over-Year growth across 5 regional markets
//                   </p>
//                 </div>
...
//                   </h4>
//                   <p className="text-sm text-gray-600">
//                     Targeted solutions that improve cash flow and agility
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                     Started as a 2-member consultancy with a vision to transform
//                     IT services
//                   </p>
//                 </div>
//                 <div className="relative">
...
//                     </h4>
//                     <p className="text-sm text-gray-600">
//                       Established with a focus on quality IT consulting services
//                       in Dubai
//                     </p>
//                   </div>
//                 </div>
...
//                   </h3>
//                   <p className="text-gray-600">
//                     Expanded services and geographical presence to meet growing
//                     demand
//                   </p>
//                 </div>
//               </div>
...
//                   </h3>
//                   <p className="text-gray-600">
//                     A leading provider of innovative IT solutions across
//                     multiple industries
//                   </p>
//                 </div>
//                 <div className="relative">
...
//                     </h4>
//                     <p className="text-sm text-gray-600">
//                       Recognized for delivering mission-critical infrastructure
//                       to global clients
//                     </p>
//                   </div>
//                 </div>
...
//                   To be the digital partner of choice by driving transformation
//                   through trusted and scalable IT solutions.
//                 </p>
//               </div>
//             </div>
...
//                 </h3>
//                 <p className="text-black text-center">
//                   We aim to build lasting partnerships by aligning our expertise
//                   with your success.
//                 </p>
//               </div>
//             </div>
...
//               <span className="text-sm uppercase text-white/70 tracking-wide mb-3">
//                 Leadership Panel
//               </span>
...
//                 and experience to the table, driving innovation and excellence
...
//               <div className="relative">
//                 <div
//                   className="swiper-button-prev-custom absolute left-0 top-1/2 z-10 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md cursor-pointer transform -translate-y-1/2"
//                   id="swiper-prev"
//                 >
...
//                 <div
//                   className="swiper-button-next-custom absolute right-0 top-1/2 z-10 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md cursor-pointer transform -translate-y-1/2"
//                   id="swiper-next"
//                 >
...
//             Join hundreds of businesses that trust Commnet for their technology
//             needs.
//           </p>
//           <a href="/contactus">
                ...
                >
                  {team.map((member, index) => (
                    <SwiperSlide key={index}>
                      <div
                        data-aos="fade-up"
                        className="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden h-full"
                      >
                        {member.image ? (
                          <div className="w-full h-[280px] shadow-lg overflow-hidden rounded-t-xl ">
                            <img
                              src={member.image}
                              alt={`${member.name} photo`}
                              className="w-full h-full object-cover "
                              // Moves image 20px down
                            />
                          </div>
                        ) : (
                          <div className="w-full h-[250px] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
                            <div className="w-40 h-40 rounded-full bg-sky-600 flex items-center justify-center shadow-lg">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {team.slice(0, 3).map((member, index) => (
                    ...
                    >
                      {member.image ? (
                        <div className="w-full h-[230px] shadow-lg overflow-hidden rounded-t-xl">
                          <img
                            src={member.image}
                            alt={`${member.name} photo`}
                            className="w-full h-full object-cover "
                        ...
                        <div className="w-full h-[230px] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-3">
                    ...
                    {team.slice(3, 4).map((member, index) => (
                      ...
                      >
                        <div className="w-full h-[200px] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-3">
                          {member.image ? (
                            <div className="w-24 h-32 shadow-lg overflow-hidden rounded-lg border-4 border-white">
                              <img
                                src={member.image}
                                alt={`${member.name} photo`}
                                className="w-full h-full object-cover"
