...
//   return (
//     <div
//       className="flex max-w-[1440px] mx-auto py-[6.25em] flex-col lg:flex-row gap-6 xl:gap-20 lg:px-10 px-5"
...
//         <h2
//           data-aos="fade-up"
//           className="text-[2em] lg:text-[2.5em] xl:text-[3em] font-normal tracking-tighter leading-[1.14] mb-0"
//         >
//           At <span className="text-sky-600">Commnet, </span>
//           we deliver value by combining the{" "}
//           <span className="font-bold text-sky-600">
//             right people, processes, technologies, and proven methodologies
//           </span>{" "}
//           to offer scalable, cost-effective solutions tailored to client needs
//         </h2>
//         <div className="mb-[1.25em] hidden md:flex">
//           <p
//             data-aos="fade-up"
    ...
    >
      ...
      >
        <h2
          ...
          className="text-[2em] lg:text-[2.5em] xl:text-[3em] font-normal tracking-tighter leading-[1.14] mb-0"
        >
          At <span className="font-bold text-sky-600">Commnet,</span> we deliver
